...
//     scenes(vk, 500000, 500000, 300, 300),
...
//     {
//         scenes.add_from_gltf(vk, uploader, immediate_submiter, {"assets/flight-helmet.glb"});
//         // scenes.add_from_gltf(vk, uploader, immediate_submiter, {"assets/mytests/2.glb"});
//         // scenes.add_from_gltf(vk, uploader, immediate_submiter, {"assets/mytests/1.glb"});
//         draw_commands = scenes.prepare_to_draw_scene(0, uploader);
//
...
//     }
//
//     void draw_scene(const fmat4 &view_transform){
...
//     }
//
//     void draw(const fmat4 &view_transform){
